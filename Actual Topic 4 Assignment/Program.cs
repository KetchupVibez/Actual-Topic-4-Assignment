namespace Actual_Topic_4_Assignment
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            double salary, average, calc1, calc2, calc3, price1, price2, totalPrice;
            ...
            totalPrice = (price1 + price2) * 0.80 * 1.13;
            Console.WriteLine("Your total for your " + item1 + " and " + item2 + " comes to " + totalPrice.ToString("C") + " with your discount.");
        }
    }
}
